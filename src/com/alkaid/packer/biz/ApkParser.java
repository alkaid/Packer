...
import com.alkaid.packer.Version;
import com.alkaid.packer.model.ApkInfo;
import com.alkaid.packer.model.ImpliedFeature;
...
//		try {
//			String demo = "C:/Users/df/Downloads/PokerGame_A_Plan_1.1.0_201410180234.apk";
//			if (args.length > 0) {
//				if(args[0].equals("-version") || args[0].equals("-v")){
//					System.out.println("ApkUtil   -by alkaid");
//					System.out.println("Version:" + Version.getVersion());
//					return;
//				}
//				demo = args[0];
//			}
//			ApkInfo apkInfo = new ApkParser().getApkInfo(demo);
...
//	}
	 ...
	 * @return
	 */
	public static InputStream extractFileFromApk(File apk, String fileName) {
		try {
			ZipFile zFile = new ZipFile(apk);
	...
	public static void extractFileFromApk(File apk, String fileName, String outputPath) throws Exception {
		InputStream is = extractFileFromApk(apk, fileName);
...
//				apkpath = args[0];
//			}
//			ApkInfo apkInfo = new ApkParser().getApkInfo(apkpath);
//			System.out.println(apkInfo);
